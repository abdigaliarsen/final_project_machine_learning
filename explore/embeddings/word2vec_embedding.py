...
submission_path = os.path.join(project_directory, "submissions", "word2vec_submission.csv")

word2vec_model_path = os.path.join(project_directory, "vectors", "GoogleNews-vectors-negative300.bin")
...
embedding_dim = 300  # Word2Vec embeddings typically have a dimension of 300
